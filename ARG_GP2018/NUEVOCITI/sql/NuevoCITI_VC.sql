...
/****** Object:  StoredProcedure [dbo].[NuevoCITI_VC]    Script Date: 5/21/2019 2:21:39 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[NuevoCITI_VC] @PERIODO CHAR(6), @REPORTE CHAR(15)
AS
...
SELECT A.DOCNUMBR
	 ...
	 , RIGHT('00000' + ISNULL(RTRIM(SUBSTRING(A.DOCNUMBR, CHARINDEX(' ',a.DOCNUMBR)+2,(CHARINDEX('-',a.DOCNUMBR)-1)-(CHARINDEX(' ',a.DOCNUMBR)+1))), '00000'), 5) PDV
	 --, '000000000000' + ISNULL(SUBSTRING(A.DOCNUMBR, ISNULL(AW2.Pos_NRO, AW4.Pos_NRO), 8), '0000') NROCOMP
	 , RIGHT('00000000000000000000' + ISNULL(RTRIM(SUBSTRING(A.DOCNUMBR, ISNULL(AW2.Pos_NRO, AW4.Pos_NRO), 8)), '00000000'),20) NROCOMP
	 , RIGHT(ISNULL(TRX.TXRGNNUM, CM.TXRGNNUM), 2) CODCOC
	 , RTRIM(LEFT(ISNULL(TRX.TXRGNNUM, CM.TXRGNNUM), 11)) NROIDENT
...
WHERE ISNULL(TRX.VOIDSTTS, CC.VOIDSTTS) = 0 
