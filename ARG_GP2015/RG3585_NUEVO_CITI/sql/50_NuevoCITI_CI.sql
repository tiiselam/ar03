/****** Object:  StoredProcedure [dbo].[NuevoCITI_CI]    Script Date: 08/13/2015 18:14:31 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[NuevoCITI_CI]') AND type in (N'P', N'PC'))
DROP PROCEDURE [NuevoCITI_CI]
GO

/****** Object:  StoredProcedure [dbo].[NuevoCITI_CI]    Script Date: 25/04/2019 14:38:39 ******/
SET ANSI_NULLS ON
GO
