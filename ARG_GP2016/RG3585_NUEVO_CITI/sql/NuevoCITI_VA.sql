...
/****** Object:  StoredProcedure [dbo].[NuevoCITI_VA]    Script Date: 25/04/2019 14:39:11 ******/
SET ANSI_NULLS ON
GO
...
INSERT INTO #TEMPA
SELECT A.DOCNUMBR, A.RMDTYPAL, A.CUSTNMBR, ISNULL(TRX.DOCDATE, CC.DOCDATE) DOCDATE, '0' + ISNULL(ISNULL(AW2.COD_COMP, AW3.COD_COMP), '00') COMTYPE,  RIGHT('00000' + ISNULL(RTRIM(SUBSTRING(A.DOCNUMBR, CHARINDEX(' ',a.DOCNUMBR)+2,(CHARINDEX('-',a.DOCNUMBR)-1)-(CHARINDEX(' ',a.DOCNUMBR)+1))), '00000'), 5) PDV,
