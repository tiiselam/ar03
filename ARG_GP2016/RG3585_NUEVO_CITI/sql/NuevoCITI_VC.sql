...
/****** Object:  StoredProcedure [dbo].[NuevoCITI_VC]    Script Date: 25/04/2019 14:31:29 ******/
SET ANSI_NULLS ON
GO
...
INSERT INTO #TEMPA
SELECT A.DOCNUMBR, A.RMDTYPAL, A.CUSTNMBR, ISNULL(TRX.DOCDATE, CC.DOCDATE) DOCDATE, '0' + ISNULL(ISNULL(AW2.COD_COMP, AW3.COD_COMP), '00') COMTYPE
	, RIGHT('00000' + ISNULL(RTRIM(SUBSTRING(A.DOCNUMBR, CHARINDEX(' ',a.DOCNUMBR)+2,(CHARINDEX('-',a.DOCNUMBR)-1)-(CHARINDEX(' ',a.DOCNUMBR)+1))), '00000'), 5) PDV,
	'000000000000' + ISNULL(SUBSTRING(A.DOCNUMBR, ISNULL(AW2.Pos_NRO, AW4.Pos_NRO), 8), '0000') NROCOMP, 
RIGHT(ISNULL(TRX.TXRGNNUM, CM.TXRGNNUM), 2) CODCOC, RTRIM(LEFT(ISNULL(TRX.TXRGNNUM, CM.TXRGNNUM), 11)) NROIDENT,
LEFT(RTRIM(ISNULL(TRX.CUSTNAME, CM.CUSTNAME)) + REPLICATE(' ', 30), 30) NOMBRE, ISNULL(TRX.DOCAMNT, CC.ORTRXAMT) DOCAMNT,
