/****** Object:  StoredProcedure [dbo].[NuevoCITI_CC]    Script Date: 08/13/2015 18:14:31 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[NuevoCITI_CC]') AND type in (N'P', N'PC'))
DROP PROCEDURE [NuevoCITI_CC]
GO

/****** Object:  StoredProcedure [dbo].[NuevoCITI_CC]    Script Date: 25/04/2019 14:37:34 ******/
SET ANSI_NULLS ON
GO
