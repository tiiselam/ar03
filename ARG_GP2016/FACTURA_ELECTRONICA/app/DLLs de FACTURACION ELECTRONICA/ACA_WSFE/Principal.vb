...
Public Class Principal
                ...
                If adicionalesstr <> "" Then
                    Do While (testxmlopcional.Read())
                        Select Case testxmlopcional.NodeType
                            Case XmlNodeType.Element 'Mostrar comienzo del elemento.
                                opcionalxml = opcionalxml & "<" & testxmlopcional.Name & ">"
                                gGrabaLog("   OPC " & "t Name " & testxmlopcional.Name)
                                Select Case testxmlopcional.Name
                                    Case "Id"
                                        opcionalesid = 1
                                    Case "Valor"
                            ...
                            Case XmlNodeType.Text 'Mostrar el texto en cada elemento.
                                opcionalxml = opcionalxml & testxmlopcional.Value
                                gGrabaLog("   OPC " & "t Value " & testxmlopcional.Value)
                                Select Case opcionalesid
                                    Case 1
                                        TempValue = testxmlopcional.Value
                                        OpcionalID(t) = Val(TempValue)
                            ...
                            Case XmlNodeType.EndElement
                                opcionalxml = opcionalxml & "</" & testxmlopcional.Name & ">"
                                gGrabaLog("   Opcional XML  " & opcionalxml)
                                If testxmlopcional.Name = "Opcional" Then
                                    t = t + 1
                                End If
                        End Select
                    Loop
                    'MsgBox(tribxml)
                    gGrabaLog("1.OPC - t " & t - 1 & "Rech " & desc_rechazo)
                    For tt = 1 To t - 1
                        gGrabaLog("1.OPC - tt " & tt & "ID " & OpcionalID(tt) & "VAL " & OpcionalValor(tt))
                        Dim Opcional As New wsfev1t.Opcional
                        With Opcional
                            .Id = OpcionalID(tt)
                            .Valor = OpcionalValor(tt)
    ...
    Public Function ObtieneCAEPIMSAL(
        ...
        gGrabaLog("C O M I E N Z O ObtCAEIMPSAL 22.4.2021")
        gGrabaLog("Data")
        gGrabaLog(cuit)
        gGrabaLog(strcantidadreg)
        gGrabaLog(presta_serv)
        ...
        gGrabaLog(adicionalesstr)
        gGrabaLog("Fin Data")
        gGrabaLog("PAram Tok: " & strToken)
        gGrabaLog("PAram Sig: " & strSign)
        gGrabaLog("ObtieneCAEIMPSAL Code")
                        ...
                        Select Case testxmlopcional.NodeType
                            ...
                            Case XmlNodeType.Text 'Mostrar el texto en cada elemento.
                                ...
                                Select Case opcionalesid
                                    Case 1
                                        TempValue = testxmlopcional.Value
                                        'gGrabaLog("       OPC Case 1 " & t & "TempValue " & TempValue)
                                        OpcionalID(t) = Val(TempValue)
                                    Case 2
                                        TempValue = testxmlopcional.Value
                                        'gGrabaLog("       OPC Case 2 " & t & "TempValue " & TempValue)
                                        OpcionalValor(t) = TempValue
                                End Select
                            Case XmlNodeType.EndElement
                                opcionalxml = opcionalxml & "</" & testxmlopcional.Name & ">"
                                ...
                                If testxmlopcional.Name = "Opcional" Then
                                    t = t + 1
                                    ReDim Preserve OpcionalID(t)
                                    ReDim Preserve OpcionalValor(t)
                                End If
                        End Select
                    Loop
                    gGrabaLog("1. Opcional XML  " & opcionalxml)
                    'MsgBox("Este es el tribxml" + tribxml)
                    'gGrabaLog("1- " & desc_rechazo)
                    gGrabaLog("  1.OPC - Cantidad " & t - 1 & "Rech " & desc_rechazo)
                    For tt = 1 To t - 1
                        gGrabaLog("1.OPC - Posicion: " & tt & " ID: " & OpcionalID(tt) & " VAL: " & OpcionalValor(tt))
                        Dim Opcional As New wsfev1t.Opcional
                        With Opcional
                            .Id = OpcionalID(tt)
                            .Valor = OpcionalValor(tt)
        ...
        'gGrabaLog("XML REponse OPC - " + objFEResponseOPC.ResultGet.Length.ToString)
        'For m = 0 To (objFEResponseOPC.ResultGet.Length - 1)
        'gGrabaLog("XML REponse id - " + m.ToString + " " + objFEResponseOPC.ResultGet(m).Id.ToString)
        'Next m
        ...
        Try
            ...
            Else
                ...
                For d = 0 To (ii - 1)
                    ...
                    gGrabaLog("CADENA QR: " & cadena)


                    Dim gqr As New Generarqr(cadena, libreria, sertip)
                    'gGrabaLog("Volvi Generar QR: ")
                    ...
                    gGrabaLog("7 - FINAL - " & ObtieneCAEPIMSAL)
