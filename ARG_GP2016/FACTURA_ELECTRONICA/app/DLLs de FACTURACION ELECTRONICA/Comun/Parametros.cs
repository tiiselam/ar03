    ...
    public class Parametros
    {
        ...
        public Parametros()
        {
            try
            {
                ...
                //var resourceName = "Comun.ParametrosCfdi.xml";
                //Stream stream = assembly.GetManifestResourceStream(resourceName);
                //XmlDocument listaParametros = new XmlDocument();
                //listaParametros.Load(new XmlTextReader(stream));                         
                XmlDocument listaParametros = new XmlDocument();
                listaParametros.Load(new XmlTextReader("ParametrosCfdi.xml"));
                MessageBox.Show("Encontro y cargo el archivo de parámetros de conexión");
