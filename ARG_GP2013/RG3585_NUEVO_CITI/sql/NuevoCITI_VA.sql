...
/****** Object:  StoredProcedure [dbo].[NuevoCITI_VA]    Script Date: 04/25/2019 14:50:28 ******/
SET ANSI_NULLS ON
GO
...
INSERT INTO #TEMPA
SELECT A.DOCNUMBR, A.RMDTYPAL, A.CUSTNMBR, ISNULL(TRX.DOCDATE, CC.DOCDATE) DOCDATE, '0' + ISNULL(ISNULL(AW2.COD_COMP, AW3.COD_COMP), '00') COMTYPE, '0' + ISNULL(SUBSTRING(A.DOCNUMBR, ISNULL(AW2.Pos_PDV, AW4.Pos_PDV), 5), '00000') PDV,
...
WHERE ISNULL(TRX.VOIDSTTS, 0) = 0 AND ISNULL(CC.VOIDSTTS, 0) = 0 and left(CONVERT(char(8), ISNULL(TRX.DOCDATE, CC.DOCDATE), 112), 6) = @PERIODO AND CI.TipoReporte = 2
...
FROM #TEMP2 WHERE dbo.fncESNUMERICO(PDV) = 1 AND PDV <> '00000'
