...
/****** Object:  StoredProcedure [dbo].[NuevoCITI_CC]    Script Date: 04/25/2019 14:15:27 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE[dbo].[NuevoCITI_CC] @PERIODO CHAR(6), @REPORTE CHAR(15), @NOGRAVADO tinyint
AS

-- EXEC NuevoCITI_CC '201710', 'IVA COMPRAS', 1
...
WHERE T.COMPTYPE IN('001', '002', '003', '051', '052', '053', '066','084')
...
AND COMPTYPE IN('001', '002', '003', '051', '052', '053', '066','084') 
...
----AND A.COMPTYPE NOT IN('006', '007', '008', '011', '012', '013','084'))
--- OR A.COMPTYPE IN('006', '007', '008', '011', '012', '013','084'))
